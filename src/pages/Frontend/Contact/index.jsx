      ...
      <div className="container my-5 py-4">
        <Row gutter={[32, 32]}>
          ...
          <Col xs={24} md={10}>
            ...
            <p><PhoneOutlined style={{ marginRight: 8 }} /> +1 (234) 567-890</p>
            <p><MailOutlined style={{ marginRight: 8 }} /> contact@raghadfabrics.com</p>
            <p><EnvironmentOutlined style={{ marginRight: 8 }} /> 123 Food Street, Taste City</p>
          </Col>
