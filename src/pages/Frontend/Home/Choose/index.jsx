                ...
                <Row gutter={[18, 18]} >
                    <Col xs={24} sm={24} md={12} lg={8} data-aos="fade-up" data-aos-delay="100" >
                        <Card hoverable className="rounded-5 shadow text-center" >
                            <Image src='https://img.icons8.com/?size=100&id=57926&format=png&color=000000' alt="Innovation" width={70} height={70} preview={false} style={{ borderRadius: '50%', objectFit: 'cover', marginBottom: '10px' }} />
                    ...
                    <Col xs={24} sm={24} md={12} lg={8} data-aos="fade-up" data-aos-delay="200" >
                        <Card hoverable className="rounded-5 shadow text-center" >
                            <Image src='https://img.icons8.com/?size=100&id=23535&format=png&color=000000' alt="Quality Focused" width={70} height={70} preview={false} style={{ borderRadius: '50%', objectFit: 'cover', marginBottom: '10px' }} />
                    ...
                    <Col xs={24} sm={24} md={12} lg={8} data-aos="fade-up" data-aos-delay="300" >
                        <Card hoverable className="rounded-5 shadow text-center" >
                            <Image src='https://img.icons8.com/?size=100&id=yzkidsOEr2yT&format=png&color=000000' alt="Value for money" width={70} height={70} preview={false} style={{ borderRadius: '50%', objectFit: 'cover', marginBottom: '10px' }} />
